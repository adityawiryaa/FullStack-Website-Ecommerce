...
dataProduct.post('/product',adminAuth,uploads.single('image'),productController.postProduct)
...
dataProduct.get('/product/category/:categoryID',productController.getCategory)
